  ...
  return (
    <>
      <div className='w-full max-w-md mx-auto shadow-md rounded-lg px-4 my-8 text-orange-500 bg-gray-700'>
        <h1 className='text-white text-center my-3 text-2xl py-5'>Password Generator</h1>
        <div className='flex shadow rounded-lg overflow-hidden mb-4'>
          ...
          <button className='outline-none bg-blue-700 text-white px-3 py-0.5 shrink-0 hover:bg-red-500' onClick={copyPasswordToClipboard}>Copy</button>
        </div>
        <div className='flex text-sm gap-x-2'>
          <div className=' flex items-center gap-x-1'>
            <input type='range' min={4} max={20} value={length} className='cursor-pointer my-3' onChange={(e) => {setLength(e.target.value)}}></input>
